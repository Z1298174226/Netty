...
public class HttpFileHandler extends SimpleChannelInboundHandler<HttpObject>{  
  ...
  //private final StringBuilder responseContent = new StringBuilder();  
    ...
    protected void messageReceived(ChannelHandlerContext ctx, HttpObject msg) throws Exception {  
        ...
        JSONObject jObject = new JSONObject().put("code", "404").put("msg", "妈的渣渣，找不到怎么办");  
        ...
        if (msg instanceof HttpRequest) {  
            ...
            if (decoder != null && readingChunks) {  
                ...
                /*
                 * when read the LastHttpContent,encoding end 
                 */
    ...
    private void readHttpDataChunkByChunk() {  
        try {  
            while (decoder.hasNext()) {  
                ...
                /*
                 * This decoder will decode Body and can handle POST 
                 * BODY (or for PUT, PATCH or OPTIONS).
                 */
                if (data != null) {  
                    try {  
                        // new value  
                        ...
                        data.release();
                        /*
                         * Be aware of to use release after handling the decoder
                         */
                    }  
                }  
            }  
